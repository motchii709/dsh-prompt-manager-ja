...
function resolvable(name: string, variables: Readonly<Record<string, string | undefined>>): boolean {
 ...
 */
export function malformedReferences(text: string): string[] {
  const found: string[] = []
